...
c      knudsen = 2.23d0 * diffusivity / (velocity * diameter_m)
...
!	  if (knudsen.ge.5.d0) then
c     Free molecular regime.
         rate = 3.141592653589d0 * 2.5d-1 * velocity * accomodation
     $        * diameter_m * diameter_m
      else
c     Transition regime. See Dahneke, 1983.
C         rate = 6.283185307178d0 * diffusivity * diameter_m
C     $        * (1.d0 + knudsen)
C     $        / (1.d0 + 2.d0 * (1.d0 + knudsen)
C     $        * knudsen / accomodation)

c     Transition regime. See Fuchs and Sutugin, 1971.
         rate = 6.283185307178d0 * diffusivity * diameter_m
     $        * (7.5d-1*accomodation*(1.d0 + knudsen))
     $        / (knudsen*knudsen+knudsen+2.83d-1*knudsen
     $        *accomodation+7.5d-1*accomodation)
      end if
