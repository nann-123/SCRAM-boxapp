...
!!     Author(s): Hilel Dergaoui & Shupeng Zhu
!!
...
!------------------------------------------------------------------------
    ...
    Print*,"Check coefficient repartition data..."
    sumcr=0.d0
    do k=1,N_size 
...
end module CoefficientRepartition
