...
!     Function: compute_bidisperse_coagulation_kernel
!
...
!    Mmin corresponds roughly to an aerosol of diameter Dmin and a
!     specific mass equal to 1.D-06 µg.µm-3.

     

!     eventually correct inputs
      d1c = dmax1(d1, dmin)
      d2c = dmax1(d2, dmin)
      m1c = dmax1(m1, mmin)
      m2c = dmax1(m2, mmin)
      
!     knudsen number for particles in air
...
!     mean quadratic aerosol velocity  ! m.s-1
...
!     average values
    ...
    end subroutine compute_bidisperse_coagulation_kernel
